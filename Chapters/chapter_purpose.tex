%*****************************************
\chapter{Cel, założenia i zakres pracy}\label{ch:purpose}
%*****************************************

\section{Cel}

Celem pracy jest stworzenie, zademonstrowanie i ewaluacja systemu śledzenia palców przy wykorzystaniu technologii IR\graffito{IR, infrared \ppauza podczerwień.}.
